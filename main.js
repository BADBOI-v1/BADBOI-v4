//base by Lord_badboi (Badboi Bot Inc.)
//YouTube: @BADBOI-k2i
   ...
   if (pairingCode && !XeonBotInc.authState.creds.registered) {
    ...
    XeonBotInc.ev.on('messages.upsert', async chatUpdate => {
        ...
        try {
            ...
            require("./BadboiV4")(XeonBotInc, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
...
XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
	        ...
	        console.log(chalk.magenta(`\n${themeemoji} YT CHANNEL: BADBOI`))
            console.log(chalk.magenta(`${themeemoji} GITHUB: BADBOI-v1 `))
            console.log(chalk.magenta(`${themeemoji} INSTAGRAM: @BADBOI `))
