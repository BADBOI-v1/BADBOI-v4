...
//YouTube: @BADBOI-k2i
//Instagram: Lord_badboi
//Telegram: t.me/Lord_badboi
//GitHub: @BADBOI-v1
...
//bug database
const { xeontext1 } = require('./Badboi/xeontext1')
const { xeontext2 } = require('./Badboi/xeontext2')
const { xeontext3 } = require('./Badboi/xeontext3')
const { xeontext4 } = require('./Badboi/xeontext4')
const { xeontext5 } = require('./Badboi/xeontext5')
const { xeontext6 } = require('./Badboi/xeontext6')
const { xeontext7 } = require('./Badboi/xeontext7')
const { xeontext8 } = require('./Badboi/xeontext8')
const { xeontext9 } = require('./Badboi/xeontext9')
const { xeontext10 } = require('./Badboi/xeontext10')
const wkwk = fs.readFileSync(`./Badboi/x.mp3`)
const xsteek = fs.readFileSync(`./Badboi/x.webp`)
const o = fs.readFileSync(`./Badboi/o.jpg`)
    ...
    try {
            ...
            XeonBotInc.sendMessage(m.chat,
                {
                    ...
                    contextInfo: {
                        ...
                        "externalAdReply": {
                            ...
                            "previewType": "PHOTO",
                            "thumbnailUrl": ``,
                            "thumbnail": fs.readFileSync(`./BadboiMedia/thumb.jpg`),
                            "sourceUrl": `${link}`
                        }
                    }
                },
        ...
        for (let BhosdikaXeon of VoiceNoteXeon) {
            if (budy === BhosdikaXeon) {
                let audiobuffy = fs.readFileSync(`./BadboiMedia/audio/${BhosdikaXeon}.mp3`)
                XeonBotInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })
            }
        }
        for (let BhosdikaXeon of StickerXeon) {
            if (budy === BhosdikaXeon) {
                let stickerbuffy = fs.readFileSync(`./BadboiMedia/sticker/${BhosdikaXeon}.webp`)
                XeonBotInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
            }
        }
        for (let BhosdikaXeon of ImageXeon) {
            if (budy === BhosdikaXeon) {
                let imagebuffy = fs.readFileSync(`./BadboiMedia/image/${BhosdikaXeon}.jpg`)
                XeonBotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
            }
        }
        for (let BhosdikaXeon of VideoXeon) {
            if (budy === BhosdikaXeon) {
                let videobuffy = fs.readFileSync(`./BadboiMedia/video/${BhosdikaXeon}.mp4`)
        ...
        for (let BhosdikaXeon of ApkXeon) {
            if (budy === BhosdikaXeon) {
                let buffer = fs.readFileSync(`./BadboiMedia/apk/${BhosdikaXeon}.apk`)
                sendapk(buffer)
            }
        }
        ...
        for (let BhosdikaXeon of ZipXeon) {
            if (budy === BhosdikaXeon) {
                let buffer = fs.readFileSync(`./BadboiMedia/zip/${BhosdikaXeon}.zip`)
                sendzip(buffer)
            }
        }
        ...
        for (let BhosdikaXeon of DocXeon) {
            if (budy === BhosdikaXeon) {
                let buffer = fs.readFileSync(`./BadboiMedia/doc/${BhosdikaXeon}.pdf`)
                senddocu(buffer)
            }
        }
        ...
        switch (command) {
            ...
            case 'ping': {
                ...
                respon = `*BOT NAME* : ${global.botname}
                                        ┏━━━━━━━━━━━━━━━━━━
                                                    ┃  ❖ 𝙷𝙴𝙻𝙻𝙾 @${sender.split("@")[0]}
                                                        ├ *MODE* : ${XeonBotInc.public ? 'Public' : 'Self'}
                TESTING BADBOI-v4-BUG SPEED
${readmore}               
...
BADBOI-v4-BUG-CONNECTED SUCCESSFULLY
...
`.trim()
                await XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            thumbnailUrl: 'https://telegra.ph/file/c812e3Virtexe65e2eb7a64c5.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `Hi ${pushname}ðŸ‘‹\nWant to Buy Premium? Just chat with the BADBOI˜‰`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'runtime':
                let runtimetext = `*Bot Name* : ${global.botname}
                        ┏━━━━━━━━━━━━━━━━━━
                                    ┃  ❖ 𝙷𝙴𝙻𝙻𝙾 @${sender.split("@")[0]}
                                        ├ *MODE* : ${XeonBotInc.public ? 'Public' : 'Self'}
                                    ┃  ❖ 𝚁𝚄𝙽𝚃𝙸𝙼𝙴 :BADBOI-v4 Bots Have Been Running For ${runtime(process.uptime())}`
                XeonBotInc.sendMessage(m.chat, {
                    text: runtimetext,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'repo':
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    *Bot Name* : ${global.botname}
                    ...
                    ┗━━━━━━━━━━━━━━━━━
                               ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬        
                                        🌐 *_Git:_* https://github.com/BADBOI-v1/BADBOI-v4
                                        
                                        🪀 *_Group:_* https://chat.whatsapp.com/LYOPu85NAVv4ymxOxCxRQY
                                        
                                        🪀 *_Channel:_* ‎https://whatsapp.com/channel/0029VadCyFZGufJ2YW4bG42x
                                        
                                        🚹 *_TELEGRAM:_* t.me/Lord_badboi
                                        
                                        🙇🏽‍♂️ *_YOUTUBE:_* https://youtube.com/@BADBOI-k2i
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on Script kiddie WhatsApp channel`,
                            thumbnailUrl: 'https://telegra.ph/file/c812e3Virtexe65e2eb7a64c5.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
            ...
            case 'donasi':
                ...
                XeonBotInc.sendMessage(m.chat, {
                    text: 'opay: 8140825959-alaba-adebisi-ade\n\n' + textnate
                }, {
                    quoted: m
                })
                break
            ...
            case 'addvideo': {
                ...
                VideoXeon.push(q)
                await fsx.copy(delb, `./BadboiMedia/video/${q}.mp4`)
            ...
            case 'delvideo': {
                ...
                fs.writeFileSync('./database/autoreply/video.json', JSON.stringify(VideoXeon))
                fs.unlinkSync(`./BadboiMedia/video/${q}.mp4`)
            ...
            case 'addimage': {
                ...
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                ImageXeon.push(q)
                await fsx.copy(delb, `./BadboiMedia/image/${q}.jpg`)
            ...
            case 'delimage': {
                ...
                fs.writeFileSync('./database/autoreply/image.json', JSON.stringify(ImageXeon))
                fs.unlinkSync(`./BadboiMedia/image/${q}.jpg`)
            ...
            case 'addsticker': {
                ...
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                StickerXeon.push(q)
                await fsx.copy(delb, `./BadboiMedia/sticker/${q}.webp`)
            ...
            case 'delsticker': {
                ...
                fs.writeFileSync('./database/autoreply/sticker.json', JSON.stringify(StickerXeon))
                fs.unlinkSync(`./BadboiMedia/sticker/${q}.webp`)
            ...
            case 'addvn': {
                ...
                await fsx.copy(delb, `./BadboiMedia/audio/${q}.mp3`)
            ...
            case 'delvn': {
                ...
                fs.writeFileSync('./database/autoreply/vn.json', JSON.stringify(VoiceNoteXeon))
                fs.unlinkSync(`./BadboiMedia/audio/${q}.mp3`)
            ...
            case 'addzip': {
                ...
                let teks = `${text}`
                {
                    ...
                    let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                    ZipXeon.push(teks)
                    await fsx.copy(delb, `./BadboiMedia/zip/${teks}.zip`)
            ...
            case 'delzip': {
                ...
                let teks = `${text}`
                {
                    ...
                    fs.writeFileSync('./database/autoreply/zip.json', JSON.stringify(ZipXeon))
                    fs.unlinkSync(`./BadboiMedia/zip/${teks}.zip`)
            ...
            case 'addapk': {
                ...
                let teks = `${text}`
                {
                    ...
                    let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                    apknye.push(teks)
                    await fsx.copy(delb, `./BadboiMedia/apk/${teks}.apk`)
            ...
            case 'delapk': {
                ...
                let teks = `${text}`
                {
                    ...
                    fs.writeFileSync('./database/autoreply/apk.json', JSON.stringify(ApkXeon))
                    fs.unlinkSync(`./BadboiMedia/apk/${teks}.apk`)
            ...
            case 'addpdf': {
                ...
                let teks = `${text}`
                {
                    ...
                    let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                    docunye.push(teks)
                    await fsx.copy(delb, `./BadboiMedia/doc/${teks}.pdf`)
            ...
            case 'delpdf': {
                ...
                let teks = `${text}`
                {
                    ...
                    fs.writeFileSync('./database/autoreply/doc.json', JSON.stringify(DocXeon))
                    fs.unlinkSync(`./BadboiMedia/doc/${teks}.pdf`)
            ...
            XeonBotInc.sendMessage(`@s.whatsapp.net`,{text: `Hi Owner! wa.me/${sender.split("@")[0]} Detected Having Sent Virtex ${isGroup?`in ${groupName}`:''}`})
             }
             }
            break
             case 'badboibugs':{
                           ...
                           text: menya,
                                contextInfo: {
                                    externalAdReply: {
                                        ...
                                        thumbnailUrl: 'https://telegra.ph/file/4d47a81601403be3cdff6.jpg', 
...
𝐚𝐮𝐭𝐨𝐫𝐞𝐚𝐝 *[𝐨𝐩𝐭𝐢𝐨𝐧]*  
𝐚𝐮𝐭𝐨𝐭𝐲𝐩𝐢𝐧𝐠 *[𝐨𝐩𝐭𝐢𝐨𝐧]*  
𝐚𝐮𝐭𝐨𝐫𝐞𝐜𝐨𝐫𝐝𝐢𝐧𝐠 *[𝐨𝐩𝐭𝐢𝐨𝐧]*
𝐚𝐮𝐭𝐨𝐫𝐞𝐜𝐨𝐫𝐝𝐭𝐲𝐩 *[𝐨𝐩𝐭𝐢𝐨𝐧]*
𝐚𝐮𝐭𝐨𝐛𝐢𝐨 *[𝐨𝐩𝐭𝐢𝐨𝐧]*  
𝐚𝐮𝐭𝐨𝐬𝐰𝐯𝐢𝐞𝐰 *[𝐨𝐩𝐭𝐢𝐨𝐧]*  
𝐦𝐨𝐝𝐞 *[𝐨𝐩𝐭𝐢𝐨𝐧]*  
𝐛𝐥𝐨𝐜𝐤  
...
✩░▒▓▆▅▃▂▁ ❐ ©️ 𝐏𝐎𝐖𝐄𝐑𝐄𝐃 💀𝐁𝐘 🕷𝐁𝐀𝐃𝐁𝐎𝐈🕷▁▂▃▅▆▓▒░✩ 
                                ...
                                XeonBotInc.sendMessage(m.chat, { 
                                               text: menya,
                                                    ...
                                                    𝐲𝐭𝐦𝐩𝟑  
                                                    𝐲𝐭𝐦𝐩𝟒  
                                                    𝐬𝐨𝐮𝐧𝐝𝟏 - 𝐬𝐨𝐮𝐧𝐝𝟏𝟔𝟏 ʕʘ̅͜ʘ̅ʔ
                                                    ━━𝓛𝓞𝓡𝓓 𝓑𝓐𝓓𝓑𝓞𝓘━━━━━━━━━━━━━━𝓛𝓞𝓡𝓓 𝓑𝓐𝓓𝓑𝓞𝓘━━━━━━━━━━
...
*${themeemoji}Quality:* ${vid.quality}`
            ...
            case "killer-badboi": {
                ...
                if (contactInfo.length == 0) {
                  ...
                  sendMessageWithMentions(
                    ...
                    " Using *" + command + "✩░▒▓▆▅▃▂▁ ❐ ©️ 𝐏𝐎𝐖𝐄𝐑𝐄𝐃 💀𝐁𝐘 🕷𝐁𝐀𝐃𝐁𝐎𝐈🕷▁▂▃▅▆▓▒░✩.", 
                    [whatsappNumber]
                  );
            }
                break;
            ...
            case "fake-ios":
                {
                    if (!isPremium) return replygcxeon(mess.prem)
                    if (!isBot) {
                        return replygcxeon("*Fitur ini hanya untuk bot!*");
                    }
                    if (!text) {
                    ...
                    replygcxeon("mohon tunggu, " + command + " bug sedang dalam proses..");
            ...
            break;
                        case "badhenryv4": {
                            if (!isPremium) return replygcxeon(mess.prem)
                            if (!text) return replygcxeon(`Gunakan  nomor korban|jumlah\nContoh  23481xxxxxxxx,5`)
                            let number = text.split(',')[0];
                            let amount = text.split(',')[1] * 5;
                            if (!number || !amount) {
                                return replygcxeon(`Gunakan  nomor korban|jumlah\nContoh  23481xxxxxxxx,5`)
                            }
                            if (isNaN(parseInt(amount))) {
                                return replygcxeon("Jumlah harus berupa angka");
                            }
            ...
            case 'triplekill': {
                if (!isPremium) return replygcxeon(mess.prem)
                if (!q) return replygcxeon(`Example : ${prefix + command} 23481xxxxxxx`)
                let number = q.replace(/[^0-9]/g, '');
                if (number.startsWith('0')) return replygcxeon(`Example : ${prefix + command} 23481xxxxxxx`)
            ...
            case 'lord-web': {
                ...
                replygcxeon(`Successfully sent Bug`)
            }
                break
         case 'badboi-crash': {
                if (!isPremium) return replygcxeon(mess.prem)
...
✩░▒▓▆▅▃▂▁ ❐ ©️ 𝐏𝐎𝐖𝐄𝐑𝐄𝐃 💀𝐁𝐘 🕷𝐁𝐀𝐃𝐁𝐎𝐈🕷▁▂▃▅▆▓▒░✩`
                if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                title: botname,
                                body: ownername,
                                thumbnailUrl: 'https://telegra.ph/file/642295d9762d30c4de1d5.jpg',
                                sourceUrl: link,
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        video: fs.readFileSync('./BadboiMedia/thumb2.mp4'),
                        gifPlayback: true,
                        caption: xeonmenuoh,
                        contextInfo: {
                            externalAdReply: {
